			...
			<div class="header">
		 	...
		 	<div class="row">
		 		<div id="box1" class="col">
		 			...
		 			<h2><a href="#">Algebra</a></h2>
		 		</div> <!--#box2-->
		 		<div id="box2" class="col">
		 			<a href="#"><img src="/DoAnThiTracNghiem/img/csharp.png" width="300px" height="300px" /></a>
		 			<h2><a href="#">C#</a></h2>
		 		</div> <!--#box2-->
		 		<div id="box3" class="col">
		 			<a href="#"><img src="/DoAnThiTracNghiem/img/law.png" width="300px" height="300px" /></a>
		 			<h2><a href="#">Pháp luật đại cương</a></h2>
		 		</div> <!--#box3-->
		 	</div> <!--#row-->
		 	<div class="row">
		 		<div id="box1" class="col">
		 			<a href="#"><img src="/DoAnThiTracNghiem/img/english.png" width="300px" height="300px" /></a>
		 			<h2><a href="#">Tiếng Anh</a></h2>
		 		</div> <!--#box2-->
		 		<div id="box2" class="col">
		 			<a href="#"><img src="/DoAnThiTracNghiem/img/physic.png" width="300px" height="300px" /></a>
		 			<h2><a href="#">Vật lý</a></h2>
		 		</div> <!--#box2-->
		 		<div id="box3" class="col">
		 			<a href="#"><img src="/DoAnThiTracNghiem/img/Geography.png" width="300px" height="300px" /></a>
		 			<h2><a href="#">Địa lý</a></h2>
		 		</div> <!--#box3-->
		 	</div> <!--#row-->
		 	<div class="content">
			<div class="footer">
