...
<br>
   <br>
   <center><h1>Xóa thí sinh</h1></center>
	...
	<th style="width: 296px; ">Full name</th>
 	...
 	<form method="POST" action="${pageContext.request.contextPath}/del_ts">

    <div class="container">
    <h2>Xóa thí sinh bằng Username hoặc Full name:</h2><br>
