...
<title>Sua thong tin thi sinh</title>
<style>
body {
  margin: 0;
...
<br>
   <br>
   <center><h1>Sửa thí sinh</h1></center>
	...
	<th style="width: 296px; ">Full name</th>
 	...
 	<form method="POST" action="${pageContext.request.contextPath}/edit_ts">
<h2>Sửa thông tin thí sinh qua UserName</h2>
    <div class="container">
      ...
      <input type="text" placeholder="Enter Username" name="username" value= "${username}" >
      	...
      	<input type="text" placeholder="Enter Full name" name="fullname" value= "${fullname}">
